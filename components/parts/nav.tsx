...
// Icon Imports
import { BarChart, Contact, Layers, LifeBuoy, Disc3, Book, SearchIcon, Target, Inbox } from "lucide-react";

const links = [
  { href: "/", text: "Dashboard", icon: BarChart },
  { href: "/endpoints", text: "Endpoints", icon: Layers },
  { href: "/leads", text: "Leads", icon: Contact },
  // { href: "/segments", text: "Segments", icon: Inbox },
  { href: "/logs", text: "Logs", icon: Disc3 },
];

const otherLinks = [
  // { href: "https://Babu/docs", text: "Documentation", icon: Book },
